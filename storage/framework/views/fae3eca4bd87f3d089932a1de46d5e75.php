...
<form action="<?php echo e(route('items.store')); ?>" method="POST" enctype="multipart/form-data" id="create-form">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group">
        ...
        <select id="category" name="category" required onchange="updateConditionalFields()">
            ...
            <option value="plant"       <?php if(old('category', $preselectedCategory ?? '') == 'plant'): echo 'selected'; endif; ?>>🌿 Plant</option>
            <option value="chore"       <?php if(old('category', $preselectedCategory ?? '') == 'chore'): echo 'selected'; endif; ?>>🧹 Chore</option>
            <option value="maintenance" <?php if(old('category', $preselectedCategory ?? '') == 'maintenance'): echo 'selected'; endif; ?>>🔧 Maintenance</option>
            <option value="pet"         <?php if(old('category', $preselectedCategory ?? '') == 'pet'): echo 'selected'; endif; ?>>🐾 Pet</option>
            <option value="other"       <?php if(old('category', $preselectedCategory ?? '') == 'other'): echo 'selected'; endif; ?>>📋 Other</option>
        </select>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group conditional-field" id="species-field">
        ...
        <input type="hidden" id="species" name="species" value="<?php echo e(old('species')); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-row">
        <div class="form-group">
            ...
            <input type="text" id="location" name="location" value="<?php echo e(old('location')); ?>" placeholder="e.g., Living Room" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group" id="frequency-group">
            ...
            <input type="number" id="action_frequency_days" name="action_frequency_days" value="<?php echo e(old('action_frequency_days', 7)); ?>" min="1" max="3650" required>
            <?php $__errorArgs = ['action_frequency_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group conditional-field" id="sunlight-field">
        ...
        <select id="sunlight_needs" name="sunlight_needs">
            ...
            <option value="low" <?php if(old('sunlight_needs') == 'low'): echo 'selected'; endif; ?>>🌑 Low (Shade)</option>
            <option value="medium" <?php if(old('sunlight_needs') == 'medium'): echo 'selected'; endif; ?>>⛅ Medium (Partial Sun)</option>
            <option value="high" <?php if(old('sunlight_needs') == 'high'): echo 'selected'; endif; ?>>🌤 High (Bright)</option>
            <option value="direct" <?php if(old('sunlight_needs') == 'direct'): echo 'selected'; endif; ?>>☀️ Direct (Full Sun)</option>
        </select>
        <?php $__errorArgs = ['sunlight_needs'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/items/create.blade.php ENDPATH**/ ?>